			...
			<div class="container">
				<div class="row">
				  <div class="col-md-6 header-row">
					 <a href="index.html" class="text-center"><img src="assests/images/logo.svg" style="width: 250px;"></a>
				  </div>
				  <div class="col-md-6 header-row">
    ...
    <div class="row">
        ...
        <div class="col-4 col-md-4">
            <H5 class="text-center row-spinner slideInUp">
                <img class="star-img spinner" style="margin: auto; width: 70px;" src="assests/images/asterisk-1.svg" alt="Extraordinary Spinner">
                <span></span>
            </H5>
        </div>
        <div class="col-4 col-md-4">
            <H5 class="text-right row-spinner slideInUp"><a href="#" style="color: aliceblue;">View Project</a></H5>
        </div>
    </div>
</div>
		  </section>
